...
Data.Nullable.toNullable = function($p1){
  return new Fay$$$(function(){
    if (Fay$$_($p1) instanceof Prelude._Just) {
      var x = Fay$$_($p1).slot1;
      return Fay$$_(Fay.FFI.Nullable)(x);
    }
  ...
  return function($p2){
    return new Fay$$$(function(){
      ...
      return (function(){
        ...
        return Fay$$_(Data.Nullable.fromNullable)(Fay$$_(Fay$$_(extract)(prefix))(text));
      })();
    });
  };
};
Data.Text.splitOn = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return Fay$$jsToFay(["list",[["user","Text",[]]]],Fay$$fayToJs(["user","Text",[]],$p2).split(Fay$$fayToJs(["user","Char",[]],$p1)));
    });
  };
};
...
Fay.Text.Type.pack = Data.Text.pack;
Fay.Text.Type.unpack = Data.Text.unpack;
Fay.Text.all = Data.Text.all;
Fay.Text.any = Data.Text.any;
Fay.Text.append = Data.Text.append;
Fay.Text.concat = Data.Text.concat;
Fay.Text.concatMap = Data.Text.concatMap;
Fay.Text.cons = Data.Text.cons;
Fay.Text.drop = Data.Text.drop;
Fay.Text.empty = Data.Text.empty;
Fay.Text.head = Data.Text.head;
Fay.Text.init = Data.Text.init;
Fay.Text.intercalate = Data.Text.intercalate;
Fay.Text.intersperse = Data.Text.intersperse;
Fay.Text.isPrefixOf = Data.Text.isPrefixOf;
Fay.Text.last = Data.Text.last;
Fay.Text.length = Data.Text.length;
Fay.Text.lines = Data.Text.lines;
Fay.Text.map = Data.Text.map;
Fay.Text.maximum = Data.Text.maximum;
Fay.Text.minimum = Data.Text.minimum;
Fay.Text.$_null = Data.Text.$_null;
Fay.Text.pack = Data.Text.pack;
Fay.Text.reverse = Data.Text.reverse;
Fay.Text.snoc = Data.Text.snoc;
Fay.Text.splitOn = Data.Text.splitOn;
Fay.Text.stripSuffix = Data.Text.stripSuffix;
Fay.Text.tail = Data.Text.tail;
Fay.Text.take = Data.Text.take;
Fay.Text.toLower = Data.Text.toLower;
Fay.Text.toUpper = Data.Text.toUpper;
Fay.Text.uncons = Data.Text.uncons;
Fay.Text.unlines = Data.Text.unlines;
Fay.Text.unpack = Data.Text.unpack;
var JQuery = {};
...
JQuery.defaultAjaxSettings = new Fay$$$(function(){
  var _ajaxSettings = new JQuery._AjaxSettings();
  _ajaxSettings.accepts = Fay.FFI.Undefined;
  _ajaxSettings.async = Fay.FFI.Undefined;
  _ajaxSettings.beforeSend = Fay.FFI.Undefined;
  _ajaxSettings.cache = Fay.FFI.Undefined;
  _ajaxSettings.complete = Fay.FFI.Undefined;
  _ajaxSettings.contentType = Fay.FFI.Undefined;
  _ajaxSettings.crossDomain = Fay.FFI.Undefined;
  _ajaxSettings.data$39$ = Fay.FFI.Undefined;
  _ajaxSettings.dataType = Fay.FFI.Undefined;
  _ajaxSettings.error$39$ = Fay.FFI.Undefined;
  _ajaxSettings.$_global = Fay.FFI.Undefined;
  _ajaxSettings.ifModified = Fay.FFI.Undefined;
  _ajaxSettings.isLocal = Fay.FFI.Undefined;
  _ajaxSettings.mimeType = Fay.FFI.Undefined;
  _ajaxSettings.password = Fay.FFI.Undefined;
  _ajaxSettings.processData = Fay.FFI.Undefined;
  _ajaxSettings.success = Fay.FFI.Undefined;
  _ajaxSettings.timeout = Fay.FFI.Undefined;
  _ajaxSettings.type$39$ = Fay.FFI.Undefined;
  _ajaxSettings.url = Fay.FFI.Undefined;
  _ajaxSettings.username = Fay.FFI.Undefined;
...
JQuery.getAttr = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["defined",[["user","Text",[]]]],Fay$$fayToJs(["user","JQuery",[]],$p2)['attr'](Fay$$fayToJs(["user","Text",[]],$p1))));
    });
  };
};
...
JQuery.select = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],jQuery(Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
  });
};
JQuery.selectEmpty = new Fay$$$(function(){
  return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],jQuery()));
});
JQuery.selectInContext = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],jQuery(Fay$$_(Fay$$fayToJs(["unknown"],$p1)), Fay$$_(Fay$$fayToJs(["unknown"],$p2)))));
    });
  };
};
...
JQuery.chainAnims = function($p1){
  return new Fay$$$(function(){
    ...
    if (Fay$$_($p1) === null) {
      return Fay$$_(Prelude.error)(Fay$$_(Data.Text.unpack)("chainAnims: empty list"));
    }
...
JQuery.after = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['after'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.append = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['append'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.appendTo = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['appendTo'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.before = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['before'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.insertAfter = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['insertAfter'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
JQuery.insertBefore = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['insertBefore'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
JQuery.prepend = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['prepend'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.prependTo = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['prependTo'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
...
JQuery.is = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_bool(Fay$$fayToJs(["user","JQuery",[]],$p2)['is'](Fay$$_(Fay$$fayToJs(["unknown"],$p1)))));
    });
  };
};
JQuery.isWith = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],Fay$$fayToJs(["user","JQuery",[]],$p2)['is'](Fay$$fayToJs(["function",[["int"],["bool"]]],$p1))));
    });
  };
};
...
var Translit = {};
Translit.Fay = {};
Translit.Fay.fromCharCode = function($p1){
  return new Fay$$$(function(){
    return Fay$$jsToFay(["user","Char",[]],String.fromCharCode(Fay$$fayToJs_int($p1)));
  });
};
Translit.Fay.charCodeAt = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
Translit.Fay.replace = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        return Fay$$jsToFay(["user","Text",[]],Fay$$fayToJs(["user","Text",[]],$p3).replace(Fay$$fayToJs(["user","Text",[]],$p1),Fay$$fayToJs(["user","Text",[]],$p2),'g'));
      });
    };
  };
};
Translit.Fay.split = function($p1){
  return function($p2){
    return new Fay$$$(function(){
...
Translit.Fay.matchI = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var txt = $p2;
      var reg = $p1;
      return Fay$$_(Translit.Fay.fromNullable)(Fay$$_(Fay$$_(function($p1){
        return function($p2){
          return new Fay$$$(function(){
            return Fay$$jsToFay(["nullable",[["list",[["user","Text",[]]]]]],Fay$$fayToJs(["user","Text",[]],$p2).match(Fay$$fayToJs(["user","Text",[]],$p1),'i'));
          });
        };
      })(reg))(txt));
    });
...
Translit.Fay.fromNullable = function($p1){
  return new Fay$$$(function(){
    if (Fay$$_($p1) instanceof Fay.FFI._Null) {
      return Prelude.Nothing;
    }
...
Translit.Hangeul = {};
Translit.Hangeul.fromHangeul = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Prelude.$46$)(Fay$$_(Fay$$_(Translit.Fay.replace)("   "))("  ")))(Fay$$_(Fay$$_(Prelude.$46$)(Fay$$_(Translit.Fay.join)(" ")))(Fay$$_(Fay$$_(Prelude.$46$)(Translit.Hangeul.fromMaybes))(Fay$$_(Fay$$_(Prelude.$46$)(Fay$$_(Prelude.map)(function($p1){
    var v = $p1;
    return Fay$$_(Fay$$_(Fay$$_(Fay$$eq)(v))(" ")) ? Fay$$_(Prelude.Just)(v) : Fay$$_(Translit.Hangeul.fromHangeulBlock)(v);
  })))(Fay$$_(Translit.Fay.split)("")))));
});
Translit.Hangeul.toHangeul = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Prelude.$46$)(Fay$$_(Translit.Fay.join)("")))(Fay$$_(Fay$$_(Prelude.$46$)(Fay$$_(Translit.Hangeul.mapMaybe)(function($p1){
    var c = $p1;
    return Fay$$_(Fay$$_(Fay$$_(Fay$$eq)(c))("")) ? Fay$$_(Prelude.Just)(" ") : Fay$$_(Fay$$_(Translit.Hangeul.$60$$36$$62$)(function($p1){
      var $gen_0 = $p1;
      return Fay$$_(Fay$$_(Data.Text.cons)($gen_0))("");
    }))(Fay$$_(Translit.Hangeul.toHangeulBlock)(c));
  })))(Fay$$_(Translit.Fay.split)(" ")));
});
Translit.Hangeul.fromHangeulBlock = function($p1){
  return new Fay$$$(function(){
    var syllable = $p1;
    return (function(){
      var aux = function($p1){
      ...
      return (function(){
        return new Fay$$$(function(){
          var code = new Fay$$$(function(){
            return Fay$$_(Fay$$_(Fay$$sub)(Fay$$_(Fay$$_(Translit.Fay.charCodeAt)(0))(syllable)))(44032);
          });
...
Translit.Hangeul.jamoFromChar = function($p1){
  return new Fay$$$(function(){
    var c = $p1;
    return Fay$$_(Fay$$_(Translit.Hangeul.$60$$36$$62$)(Translit.Fay.fromCharCode))(Fay$$_(Fay$$_(Translit.Hangeul.lookT)(c))(Translit.Hangeul.single));
  });
};
Translit.Hangeul.toHangeulBlock = function($p1){
  return new Fay$$$(function(){
    var syllable = $p1;
    return (function(){
      var aux = function($p1){
      ...
      return (function($tmp1){
        ...
        if (Fay$$_($tmp1) instanceof Prelude._Just) {
          if (Fay$$listLen(Fay$$_(Fay$$_($tmp1).slot1),4)) {
            ...
            return Fay$$_(Fay$$_(Prelude.$36$)(Fay$$_(Fay$$_(Prelude.$46$)(Prelude.Just))(Translit.Fay.fromCharCode)))(Fay$$_(Fay$$_(Fay$$_(blockCode)(Fay$$_(Fay$$_(aux)(a))(Translit.Hangeul.initial)))(Fay$$_(Fay$$_(aux)(b))(Translit.Hangeul.vowel)))(Fay$$_(Fay$$_(aux)(c))(Translit.Hangeul.$_final)));
          }
        }
        return Prelude.Nothing;
      })(Fay$$_(Fay$$_(Translit.Fay.matchI)("^([bcdghjklmnprst]*)([aeiouyw]*)([bcdghjklmnprst]*)$"))(syllable));
    })();
  });
};
        ...
        if (Fay$$listLen(Fay$$_($tmp1),2)) {
          if (Fay$$_(Fay$$index(0,Fay$$_($tmp1))) instanceof Prelude._Just) {
            ...
            if (Fay$$_(Fay$$index(1,Fay$$_($tmp1))) instanceof Prelude._Just) {
              ...
              return Fay$$_(Fay$$_(Prelude.$36$)(Prelude.Just))(Fay$$_(Fay$$_(Data.Text.append)(a$39$))(b$39$));
            }
          }
        }
        if (Fay$$listLen(Fay$$_($tmp1),2)) {
...
var FayTestWeb = {};
FayTestWeb.main = new Fay$$$(function(){
    ...
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery.select)("#out")))(function($p1){
      ...
      return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Prelude.$36$)(function($p1){
        ...
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery.getVal)(inp)))(function($p1){
          var t = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery.setVal)(Fay$$_(Translit.Hangeul.toHangeul)(t)))(out)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        });
        ...
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery.getVal)(out)))(function($p1){
          var b = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery.setVal)(Fay$$_(Translit.Hangeul.fromHangeul)(b)))(inp)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        });
      }));
    });
  }));
